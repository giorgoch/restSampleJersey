...
public class LoggingSample {
	 ...
	 * }
	 * 
	 * @Pointcut("execution(* *.*(..))") public void allMethod() {
	 * 
	 * }
	 * 
	 ...
	 * }
	 * 
	 * @Pointcut("within(com.giorgoch.projectClient..*)") private void
	 * logAnyFunctionWithinResource() { }
	 * 
	 * // before -> Any resource annotated with @Controller annotation // and
	 * all method and function taking HttpServletRequest as first parameter
	 * 
	 * @Before("controller() && allMethod() && args(..,request)") public void
	 * logBefore(JoinPoint joinPoint, HttpServletRequest request) {
	 * 
	 ...
	 * }
	 * 
	 * // After -> All method within resource annotated with @Controller
	 * annotation // and return a value
	 * 
	 ...
	 * 
	 * // After -> Any method within resource annotated with @Controller
	 * annotation // throws an exception ...Log it
	 * 
	 * @AfterThrowing(pointcut = "controller() && allMethod()", throwing =
	 * "exception") public void logAfterThrowing(JoinPoint joinPoint, Throwable
	 * exception) { log.error("An exception has been thrown in " +
	 * joinPoint.getSignature().getName() + " ()"); log.error("Cause : " +
	 * exception.getCause()); }
	 * 
	 * // Around -> Any method within resource annotated with @Controller //
	 * annotation
	 * 
	 * @Around("controller() && allMethod()") public Object
	 * logAround(ProceedingJoinPoint joinPoint) throws Throwable {
	 * 
	 * long start = System.currentTimeMillis(); try { String className =
	 ...
	 * log.debug("Method " + className + "." + methodName + " ()" +
	 ...
	 * 
	 * private String getValue(Object result) { String returnValue = null; if
	 * (null != result) { if (result.toString().endsWith("@" +
	 * Integer.toHexString(result.hashCode()))) { returnValue =
	 * ReflectionToStringBuilder.toString(result); } else { returnValue =
	 * result.toString(); } } return returnValue; }
	 */
}
